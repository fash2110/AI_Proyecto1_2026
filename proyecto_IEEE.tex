...
\caption{Vista del proyecto en Weights \& Biases: métricas por corrida (captura a incorporar).}
\label{fig:wandb}
\end{figure}
...
\caption{Evidencia de paridad PyTorch vs ONNX (figura a incorporar): error por componente o m\'aximo $|\Delta|$ en logits.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{images/android_onnx_runtime_screenshot.png}}
\caption{Aplicaci\'on Android: inferencia o demo de comandos (captura a incorporar).}
